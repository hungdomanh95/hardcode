...
const translateAroundX = [{
  translateX: aroundX.interpolate({
    inputRange: [0, 1],
    outputRange: [0, 2 * SIZE_CONTAINER - 6 * SPACING],
  }),
}]
const translateAroundY = [{
  translateY: aroundY.interpolate({
    inputRange: [0, 1],
    outputRange: [0, SIZE_CONTAINER],
  }),
}]
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={{flex: 1}}>
        <View
          ...
          <View style={[styles.containerBox, {height:2 * SIZE_CONTAINER}]}>
            <Text style={[globalStyle.h3]}> Translate Y </Text>
            <Animated.View style={[ styles.box, { transform: translateY}]}/>
          </View>

          <View style={[styles.container2Box,{backgroundColor:"green", height:2*SIZE_CONTAINER}]}>
            <Text style={[globalStyle.h3]}> Translate X </Text>
            <TouchableWithoutFeedback onPress={startRunAround}>
              <Animated.View style={[styles.box,{transform:[translateAroundX,translateAroundY]}]} />
            </TouchableWithoutFeedback>
          </View>
        </View>
      </ScrollView>
