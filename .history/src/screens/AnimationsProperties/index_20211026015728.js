      ...
      <ScrollView style={{flex: 1}}>
        <View
          ...
          <View style={{width,height:width, backgroundColor:"red", marginHorizontal:-SPACING, justifyContent:"center",alignItems:"center"}}>
            ...
            <View
              style={{width:width/1.5, height:width/1.5, backgroundColor:"green",borderRadius:1000, justifyContent:"center", alignItems:"center", borderStyle:"dashed", borderWidth:2 }}>
              <Animated.Image
                resizeMode="contain"
                source={Charizard}
                style={[
