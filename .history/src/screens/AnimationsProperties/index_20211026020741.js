      ...
      <ScrollView style={{flex: 1}}>
        <View
          ...
          <View style={{width,height:width, marginHorizontal:-SPACING, justifyContent:"center",alignItems:"center"}}>
            ...
            <View
              style={{width:width/1.5, height:width/1.5,borderRadius:1000, borderStyle:"dashed", borderWidth:2 }}>
              <Animated.Image
                resizeMode="contain"
                source={Charizard}
                style={[
