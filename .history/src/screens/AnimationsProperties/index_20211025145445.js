...
const AnimationsProperties = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView style={{width,flexDirection:"row",flexWrap:"wrap", marginHorizontal:SPACING}}>
        {/* <View style={{width:width, flexDirection:"row",flexWrap:"wrap", marginHorizontal:SPACING}}> */}
