  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{flex:1}}>
        <View style={{flexDirection:"row",justifyContent:"space-every",flexWrap:"wrap"}}>
          {listHardCode.map((item,index)=>{
            return(
              <TouchableOpacity key={index} style={{width:globalStyle.widthScreen/3, marginHorizontal:10, backgroundColor:"red"}} >
